...
import poke.resources.Databuilder;
...
public class Server {
	...
	private void startManagers() {
		...
		logger.info("---> Server.startManagers() expecting " + conf.getAdjacent().getAdjacentNodes().size()
				+ " connections");
		...
		// Call to generate data in memory data to server client request
		Databuilder.generateData();
