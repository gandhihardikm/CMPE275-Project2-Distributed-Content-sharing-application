...
public class HeartbeatData {
	...
	private AtomicBoolean isLastBeat;
	
	public boolean getIsLastBeat() {
		return isLastBeat.get();
	}

	public void setIsLastBeat(boolean isLastBeat) {
		this.isLastBeat = new AtomicBoolean(isLastBeat);
	}
	...
	public HeartbeatData(int nodeId, String host, Integer port, Integer mgmtport) {
		...
		this.isLastBeat = new AtomicBoolean(false);
	}
