...
//					RaftPeer raftPeer = new RaftPeer(req.getFromNodeId(), thisNode.getLastLogIndex()+1);
					RaftPeer raftPeer = new RaftPeer(req.getFromNodeId(), 1);
					logger.info("*** Adding peer..."+req.getFromNodeId()+"..."+raftPeer.toString());
					thisNode.addRaftPeer(raftPeer);
				}
			} else
